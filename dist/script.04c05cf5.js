...
var containerImages = document.querySelector('.images');
var imageList = document.querySelectorAll('.image');
var widthImage = imageList[0].offsetWidth;
...
next.addEventListener("click", function () {
  ...
  containerImages.style.left = "".concat(-widthImage * (currentActive - 1), "px");
  addActiveClass();
...
function addActiveClass() {
  ...
  var activeCircles = document.querySelectorAll(".active_circle");
  lineUp.style.width = "".concat((activeCircles.length - 1) / (circles.length - 1) * 100, "%");
